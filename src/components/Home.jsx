...
const Banner = ({ height, width }) => {
    ...
    const copyWriting = {
        ...
        subtitle: "不妨試試 WeCoding 打造一個免費且簡單使用的外包網站 在這裡你可以找到適合的工程師或是適合的案件",
    ...
    return (
        <>
            <Box>
                <BackgroundImage h={{ base: 400, md: 520 }} src={BannerSrc} px={{ base: 16, md: 80 }} radius={BannerRadius}>
                    <Flex direction="column" align={{ base: "center", md: "flex-start" }} justify="center" h="100%" w={{ base: "100%", md: "60%" }} >
        ...
        <>
            <Box mt={48}>
                <Container size="xl" bg="custom-third.1">
                    <Box px={{ base: 16, md: 40 }} py={{ base: 32, md: 40 }} radius={BoxRadius}>
                        <>
